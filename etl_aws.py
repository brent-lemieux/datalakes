...
aws emr add-steps --cluster-id j-2GA1WUA1WA0C4 --steps Type=spark,Name=mySparkApp,Args=[--deploy-mode,cluster,--master,yarn,s3://bwl-spark-example/etl_aws.py],ActionOnFailure=CONTINUE
"""
import os
